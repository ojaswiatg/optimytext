...
export default function Phrase() {
    ...
    function toneText(event: FormEvent<HTMLFormElement>) {
    ...
    return (
        <div className="mx-auto h-fit w-full max-w-screen-md px-auto md:px-lg mt-16 md:mt-32 pb-4">
            <form onSubmit={toneText} className="px-4 w-full grid">
                <p className="text-2xl mx-auto">Tone any text</p>
                <textarea
                    name="text"
                    id="text"
                    value={input}
